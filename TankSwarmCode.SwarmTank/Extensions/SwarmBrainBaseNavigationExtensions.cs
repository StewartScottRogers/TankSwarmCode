...
{
    internal static void NavigateTo(this SwarmTankCortexCradleBase brain, Vector2D dest, double stopDistance)
    {
    ...
    internal static void MaintainRadar(this SwarmTankCortexCradleBase brain, Vector2D? focusPoint)
    {
    ...
    internal static void LinearPredictionFire(this SwarmTankCortexCradleBase brain, RadarContact target)
    {
    ...
    internal static bool IsWallInLineOfFire(this SwarmTankCortexCradleBase brain, Vector2D target)
    {
    ...
    internal static Vector2D FurthestArenaCorner(this SwarmTankCortexCradleBase brain)
    {
        Vector2D[] corners =
        [
            new(50, 50),
