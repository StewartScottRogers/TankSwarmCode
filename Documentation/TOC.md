...
| [15](ch15-cli.md) | [Headless CLI Runner](ch15-cli.md) | `TankSwarmCode.Cli`: flags, output formats (JSON/NDJSON/table/CSV), parallel batches, Black Box telemetry (`--blackbox-dir`), and the `--list` discovery command |
