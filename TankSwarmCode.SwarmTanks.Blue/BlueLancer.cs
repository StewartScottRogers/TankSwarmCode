...
public sealed class BlueLancer : SwarmTankBase, ITankContext
{
    private readonly IAiCortex _cortex = CortexFactory.For("BlueLancer");

    public BlueLancer() { SwarmId = 2; Role = TankRole.Attacker; }

    public override string Name => "Blue9";
