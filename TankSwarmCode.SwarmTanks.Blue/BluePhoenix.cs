...
public sealed class BluePhoenix : SwarmTankBase, ITankContext
{
    private readonly IAiCortex _cortex = CortexFactory.For("BluePhoenix");

    public BluePhoenix() { SwarmId = 2; Role = TankRole.Attacker; }

    public override string Name => "Blue11";
