...
public sealed class BlueSurge : SwarmTankBase, ITankContext
{
    private readonly IAiCortex _cortex = CortexFactory.For("BlueSurge");

    public BlueSurge() { SwarmId = 2; Role = TankRole.Attacker; }

    public override string Name => "Blue6";
