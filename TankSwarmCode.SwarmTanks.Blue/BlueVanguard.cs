...
public sealed class BlueVanguard : SwarmTankBase, ITankContext
{
    private readonly IAiCortex _cortex = CortexFactory.For("BlueVanguard");

    public BlueVanguard() { SwarmId = 2; Role = TankRole.Attacker; }

    public override string Name => "Blue8";
