...
public sealed class BlueScout : SwarmTankBase, ITankContext
{
    private readonly IAiCortex _cortex = CortexFactory.For("BlueScout");

    public BlueScout() { SwarmId = 2; Role = TankRole.Attacker; }

    public override string Name => "Blue10";
