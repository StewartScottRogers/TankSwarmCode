...
public sealed class BlueRaider : SwarmTankBase, ITankContext
{
    private readonly IAiCortex _cortex = CortexFactory.For("BlueRaider");

    public BlueRaider() { SwarmId = 2; Role = TankRole.Attacker; }

    public override string Name => "Blue7";
