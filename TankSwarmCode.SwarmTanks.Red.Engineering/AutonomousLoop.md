...
- Make the minimal change to the relevant `TankConfig` value.
...
|---|---|
| `TankConfig` values in any Red tank | `Documentation/ch09-builtin-tanks.md` roster table + tank section; `TankSwarmCode.SwarmTanks.Red.Engineering/README.md` |
| New tank class added or removed | `ch09`, `ch01`, `ch02`, Red Engineering README |
| `SwarmBrainBase` strategy logic | `ch09-builtin-tanks.md` Epoch Strategies table; Red Engineering README |
